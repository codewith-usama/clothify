...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  final Map<String, List<String>> _menshirtImages = {
    'Men Shirt': [
  ...
  final Map<String, String> _menmodelImages = {
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  validator: (value) =>
                      value == null ? 'Please select a cloth type' : null,
                  items: _menshirtImages.keys.map((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value),
                    );
                ...
                if (_selectedClothType != null) ...[
                  Wrap(
                    ...
                    children: _menshirtImages[_selectedClothType]!
                        .map((image) => GestureDetector(
                              onTap: () {
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    content:
                                        Image.asset(_menmodelImages[image]!),
                                    actions: [
                                      TextButton(
                ...
                const SizedBox(height: 16),
                ElevatedButton(
                  onPressed: () {}, // Implement order placement logic
                  style: ElevatedButton.styleFrom(
                    minimumSize: const Size(
                        double.infinity, 50), // Full width and 50px height
                  ),
